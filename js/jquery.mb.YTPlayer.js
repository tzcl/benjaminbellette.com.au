...
function iOSversion() {
    ...
    jQuery.mbYTPlayer = {
        ...
        pause: function() {
            var e = this.get(0);
            return e.isReady && (e.player.pauseVideo(), e.state = 2), this
        },
        seekTo: function(e) {
            var r = this.get(0);
        ...
        getAbundance: function(e) {
            var r = this.get(0);
            return r.opt.abundance
        },
        setAbundance: function(e) {
            var r = this.get(0);
            return r.opt.abundance = e, this.optimizeDisplay(r.opt.anchor), this
        },
        ...
        if (YTPlayer.opt.optimizeDisplay) {
            ...
            for (var a in lowest && (vid.height = win.height + abundance, vid.width = Math.ceil(vid.height * YTPlayer.opt.ratio), vid.marginTop = -0 / 2, vid.marginLeft = Math.ceil(-(vid.width - win.width) / 2)), YTPAlign)
                if (YTPAlign.hasOwnProperty(a)) {
                    ...
                    switch (al) {
                        ...
                        vid.marginTop = -abundance / 2 * YTPlayer.opt.ratio;
                    }
                }
        } else vid.width = "100%", vid.height = "100%", vid.marginTop = -40, vid.marginLeft = 0;
        iframe.css({
            width: vid.width,
            height: vid.height,
